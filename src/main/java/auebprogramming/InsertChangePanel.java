...
public final class InsertChangePanel extends JPanel {
         ...
         */
        public InsertChangePanel(final MainFrame mframe,
        ...
        private void setupListeners() {
                ...
                confButton.addActionListener(new ActionListener() {
                        ...
                        public void actionPerformed(final ActionEvent event) {
                                ...
                                final JRadioButton revButton = (JRadioButton) ((JPanel) radioGroupPanel.getComponent(0))
                                                .getComponent(0);
                                final JRadioButton expButton = (JRadioButton) ((JPanel) radioGroupPanel.getComponent(1))
                                                .getComponent(0);
                                // ----------------------------------------------------
                                try {
