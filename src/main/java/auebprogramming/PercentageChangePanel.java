...
public final class PercentageChangePanel extends JPanel {
         ...
         * @param bmanager the budget manager instance
         */
        public PercentageChangePanel(final MainFrame frame,
        ...
        private void initializeComponents() {
                ...
                gbc.insets = new Insets(
                                TOP_ROW_1, LEFT_EDGE_PADDING, 0, IN_BETWEEN_GAP);

                final JLabel codeLabel = new JLabel(
                                "Πληκτρολογήστε κωδικό πηγής:", SwingConstants.LEFT);
                ...
                codeField.setPreferredSize(
                                new Dimension(
                                                FIELD_WIDTH, INPUT_FONT_SIZE + FIELD_HEIGHT_OFFSET));

                gbc.gridx = 1;
                gbc.fill = GridBagConstraints.HORIZONTAL;
                gbc.weightx = 1.0;
                gbc.insets = new Insets(
                                TOP_ROW_1, IN_BETWEEN_GAP, 0, LEFT_EDGE_PADDING);
                ...
                gbc.gridy = 1;
                gbc.insets = new Insets(
                                TOP_ROW_2, LEFT_EDGE_PADDING, 0, IN_BETWEEN_GAP);

                final JLabel percentageLabel = new JLabel(
                                "Πληκτρολογήστε ποσοστό (%):", SwingConstants.LEFT);
                ...
                gbc.gridx = 1;
                gbc.insets = new Insets(
                                TOP_ROW_2, IN_BETWEEN_GAP, 0, LEFT_EDGE_PADDING);
                ...
                gbc.gridy = 2;
                gbc.insets = new Insets(
                                TOP_ROW_3, LEFT_EDGE_PADDING, 0, IN_BETWEEN_GAP);

                final JLabel justificationLabel = new JLabel(
                                "Αιτιολόγηση:", SwingConstants.LEFT);
                ...
                gbc.gridx = 1;
                gbc.insets = new Insets(
                                TOP_ROW_3, IN_BETWEEN_GAP, 0, LEFT_EDGE_PADDING);
        ...
        private class ConfirmButtonListener implements ActionListener {
                ...
                public void actionPerformed(final ActionEvent event) {
                        ...
                        try {
                                ...
                                final String successMessage = manager.makePercentageChange(
                                                code, percentStr, justification);

                                JOptionPane.showMessageDialog(
                                                mainFrame, successMessage, "Επιτυχής Αλλαγή",
