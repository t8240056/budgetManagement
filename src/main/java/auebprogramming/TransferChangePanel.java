...
public final class TransferChangePanel extends JPanel {
        ...
        private static final Font INPUT_FONT = new Font(
                        "SansSerif", Font.PLAIN, INPUT_FONT_SIZE);
        ...
        public TransferChangePanel(final MainFrame frame,
                ...
                gbc.weightx = 1.0;
                gbc.insets = new Insets(
                                TOP_PADDING, IN_BETWEEN_GAP,
                                0, LEFT_EDGE_PADDING);
                sourceCodeField.setFont(INPUT_FONT);
                sourceCodeField.setPreferredSize(
                ...
                gbc.weightx = 0.0;
                gbc.insets = new Insets(
                                interval, LEFT_EDGE_PADDING, 0, IN_BETWEEN_GAP);
                JLabel targetLabel = new JLabel(
                                "Πληκτρολογήστε κωδικό προορισμού:",
                                SwingConstants.LEFT);
                ...
                gbc.weightx = 1.0;
                gbc.insets = new Insets(
                                interval, IN_BETWEEN_GAP, 0, LEFT_EDGE_PADDING);
                targetCodeField.setFont(INPUT_FONT);
                targetCodeField.setPreferredSize(
                                new Dimension(
                                                250,
                                                INPUT_FONT_SIZE + 10));
                ...
                gbc.insets = new Insets(
                                interval, LEFT_EDGE_PADDING, 0, IN_BETWEEN_GAP);
                final String amountLabelText = "Πληκτρολογήστε ποσό μεταφοράς:";
                JLabel amountLabel = new JLabel(
                                amountLabelText, SwingConstants.LEFT);
                ...
                gbc.insets = new Insets(
                                interval,
                                LEFT_EDGE_PADDING, BOTTOM_PADDING,
                                IN_BETWEEN_GAP);
                JLabel justificationLabel = new JLabel(
                                "Αιτιολογία:", SwingConstants.LEFT);
                ...
                gbc.weightx = 1.0;
                gbc.insets = new Insets(
                                interval, IN_BETWEEN_GAP,
                                BOTTOM_PADDING, LEFT_EDGE_PADDING);
        ...
        private void handleTransfer() {
                final String sourceCode = sourceCodeField.getText()
                                .trim();
                final String targetCode = targetCodeField.getText()
                                .trim();
                final String amountStr = amountField.getText().trim();
                final String justification = justificationField.getText()
                                .trim();
                try {
                        final String result = manager.makeTransfer(
                                        sourceCode,
                                        targetCode,
                                        amountStr,
                                        justification);
