...
public final class AbsoluteChangePanel extends JPanel {
        ...
        /**
         * Creates the form panel with
         * input fields for code, amount, and justification.
         *
        ...
        private JPanel createFormPanel() {
                ...
                JLabel codeLabel = new JLabel("Πληκτρολογήστε κωδικό φορέα:",
                                SwingConstants.LEFT);
                ...
                JLabel amountLabel = new JLabel("Πληκτρολογήστε ποσό αλλαγής:",
                                SwingConstants.LEFT);
                ...
                JLabel justificationLabel = new JLabel("Αιτιολογία:",
                                SwingConstants.LEFT);
                ...
                gbc.fill = GridBagConstraints.HORIZONTAL;
                gbc.weightx = 1.0;
                gbc.insets = new Insets(TOP_ROW_3, LEFT_EDGE_PADDING, 0,
                                IN_BETWEEN_GAP);
