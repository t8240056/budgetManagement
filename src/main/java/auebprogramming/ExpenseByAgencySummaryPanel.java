...
public final class ExpenseByAgencySummaryPanel extends JPanel {
    ...
    private void initializeTable() {
        ...
        if (data.length < 2) {
            ...
            // Δημιουργούμε έναν πίνακα μόνο με τα δεδομένα
        ...
        // Τοποθέτηση του πίνακα στο κέντρο του Panel
        add(scrollPane, BorderLayout.CENTER);
    }

    /**
     * Αρχικοποιεί την περιοχή εισαγωγής κωδικού.
     */
    private void initializeInputArea() {
        ...
        openCodeInputButton.addActionListener((final ActionEvent e) -> {
        ...
        // Τοποθέτηση στο πάνω μέρος του Panel
            ...
            if (codeField.isVisible()
                ...
                try {
                    ...
                    AppException.showError(
                            "Παρακαλώ εισάγετε έγκυρο αριθμητικό κωδικό.");
                }
            } else {
                AppException.showError(
