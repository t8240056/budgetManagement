...
*Αλγόριθμος Drill-down: Ιεραρχική πλοήγηση στα αρχεία εσόδων μέσω των RevenueDataManager και ExpenseManager.*Validation Logic: Χρήση της ChangeValidator για τη διασφάλιση οικονομικών κανόνων (αποφυγή αρνητικών υπολοίπων).
...
* src/main/resources/: Αρχεία δεδομένων CSV (2025-2026) και αποθηκευμένα σενάρια.
...
Εκτέλεση (Run)
Μπορείτε να εκτελέσετε την εφαρμογή μέσω του παραγόμενου JAR: java -jar target/budget-management-2.0.jar
